...
public:
    ...
    {
        //Serial.print(AcquireAveragedSampleCm(NUM_SAMP_FOR_AVG));
        //Serial.print('\n');
        float pressu = AcquireAveragedSampleCm(NUM_SAMP_FOR_AVG);
        return pressu;
        //Serial.print(AcquireAveragedSampleCm(NUM_SAMP_FOR_AVG));
    }
...
protected:
    ...
    int32_t PascalToCentimeter(const int32_t pressurePa)
    {
      ...
      //double pressu = pressurePa*.01;
      //double pressupow = pow(pressu/1013.25,0.190248);
      //double alt = (1-pressupow)*145366.45*.3048;
      //Serial.print(alt);
      //Serial.println('\n');
        return pressurePa;
...
*/
        ...
        const int32_t AltCm = PascalToCentimeter(pressu);
        return AltCm; 
    }
