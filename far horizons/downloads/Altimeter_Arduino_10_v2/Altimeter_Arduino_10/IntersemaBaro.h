...
//Update by boulderjoe 01/26/12 to add temperature output
...
public:
   ...
   int32_t getTemperature(void) {
       return AcquireAverageTemp(NUM_SAMP_FOR_AVG);
   }
...
protected:
    ...
    virtual int32_t AcquireAverageTemp(const uint8_t nSamples) = 0;
...
*/
    ...
    virtual int32_t AcquireAverageTemp(const uint8_t nSamples) { 
      int64_t tempAccum = 0;
        ...
        const int32_t tempF = 1.8 * (temp * .01) + 32 ; 
        return tempF;	
    }
